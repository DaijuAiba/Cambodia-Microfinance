...
merge m:1 district_code year using  "appended_CDB2014-19_vill"
drop if _merge!=3   
drop _merge
...
gen popXma=pop_size*merg_acq
gen borrXma=total_num_borrowers*merg_acq

sum amount_loan total_num_borrowers merg_acq pop_size popXma

* Regression Analysis


reg amount_loan merg_acq pop_size popXma,  r
reg amount_loan merg_acq pop_size popXma,  cluster(district_code)

reg amount_loan merg_acq total_num_borrowers borrXma,  r
reg amount_loan merg_acq total_num_borrowers borrXma,  cluster(district_code)
