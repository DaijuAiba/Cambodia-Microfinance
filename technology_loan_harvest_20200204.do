...
local all_vars harvest_kg harvest_kg_m fam_s land_s rain own_land no_loan ind_loan gr_loan tiller_equip tractor_equip other_equip manual_planting machine_planting other_planting manual_harvesting machine_harvesting  other_harvesting fert_use food_exp nonfood_exp health_exp total_exp_yr agr_inc nonagri_inc rem_inc total_inc_yr covid_trouble reduce_income
...
local x1 land_s own_land rain ind_loan gr_loan  tiller_equip tractor_equip manual_planting machine_planting manual_harvesting machine_harvesting fert_use covid_trouble
